                ...
                new List<LessonModel>
                {
                    new LessonModel("Electricity Primer",
                        ...
                        "An intro to electricity.", new List<string>
                        {
                            ...
                            "With that basic knowledge of electrons, conductors, and insulators, let us move into more exciting terms to understand our circuit better. Some of the most common things you will hear are Voltage, Current, and Resistance. Voltage is the difference in charge between two points. Current is the rate at which the charge flows. And Resistance is a material’s tendency to resist or impede the flow of charge. How do these new terms relate? Well, it all boils down to a fundamental law that describes these relationships and their effect in a circuit. This is Ohm’s Law. Voltage is represented by a V or E in older diagrams and is measured in Volts. Current is represented by an I and measured in Amps. And Resistance is represented by an R and measured in Ohms. See the below diagram and examples for a more visual interpretation of Ohm’s Law.",
