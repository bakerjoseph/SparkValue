...
{
    public class OhmsLawAdvancedOneRRule : ValidationRule
    {
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            if (!inputValue.Equals("200")) return new ValidationResult(false, "That is not the correct answer, try again.");
