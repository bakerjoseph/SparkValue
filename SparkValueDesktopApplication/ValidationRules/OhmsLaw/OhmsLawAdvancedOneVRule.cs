...
{
    public class OhmsLawAdvancedOneVRule : ValidationRule
    {
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            if (!inputValue.Equals("110")) return new ValidationResult(false, "That is not the correct answer, try again.");
